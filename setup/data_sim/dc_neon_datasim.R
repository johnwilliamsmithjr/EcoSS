## file: dc_case1_datasim.R
## simulates data for dataclone simulations with yearly observations 
## and a monthly latent state resolution
...
## ----- SYNTHESIZE DATA ---------------
LAI_fast <- c(Cf_approx[1]/LMA_e, Cf_approx[1:2189]/LMA_e)
