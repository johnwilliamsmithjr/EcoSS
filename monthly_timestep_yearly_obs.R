...
source('./setup/data_sim/monthly_timestep_yearly_obs_datasim.R')

source('./setup/MCMC/monthly_timestep_yearly_obs_MCMC.R')

##source('./monthly_timestep_yearly_obs_setup.R')
## time process
t1 <- Sys.time()
